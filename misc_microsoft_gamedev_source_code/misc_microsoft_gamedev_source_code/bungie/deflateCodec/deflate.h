...
namespace ens
{
   ...
   public:
      ...
      //
      // On entry, _in_buf_ofs and _in_buf_size indicate the size of the input buffer. On exit, _in_buf_size indicates
      ...
      // lead to better, but slower compression and vice versa.
      //
