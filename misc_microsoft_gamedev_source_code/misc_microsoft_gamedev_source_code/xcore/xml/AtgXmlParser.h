...
CONST UINT XML_MAX_ATTRIBUTES_PER_ELEMENT  =   64;
CONST UINT XML_READ_BUFFER_SIZE            =   8192;
CONST UINT XML_WRITE_BUFFER_SIZE           =   8192;   
...
public:
    ...
    virtual VOID     SetParseProgress( DWORD dwProgress ) { dwProgress; }
...
public:    
    ...
    BOOL       IsUnicode(void) const { return m_bUnicode; };        
