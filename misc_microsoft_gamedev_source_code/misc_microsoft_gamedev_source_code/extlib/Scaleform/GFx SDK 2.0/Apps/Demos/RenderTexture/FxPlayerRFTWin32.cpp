...
{
    Float mv[16], rot[16], lap[16];

    MakeIdentity(lap);
    MakeRotateZ(rot, MeshRotation * 3.141592f * 0.00555555f);
    Translate(lap, 0, 0, -2.5);
...
void    FxPlayerApp::RenderMovieTexture()
{
    ...
    Float mv[16], mvp[16], rot[16], lap[16];
...
//    Loader.SetVerboseParse(verboseFlags);
    ...
    {   
        ...
        if (Settings.DoRender)
        {
            ...
            Clear(GColor(90,0,0,255).ToColor32());
