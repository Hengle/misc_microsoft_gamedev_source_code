...
public:
    ...
    GFxFileOpener() : GFxState(State_FileOpener) { }
...
public:
    ...
    public:
        ...
        MapEntry() { Flags = MFF_Original; }
        MapEntry(const GFxString& name, MapFontFlags flags) : Name(name), Flags(flags) { }
        MapEntry(const MapEntry &src) : Name(src.Name), Flags(src.Flags) { }        
        MapEntry& operator = (const MapEntry &src)
        { Name = src.Name; Flags = src.Flags; return *this; }
