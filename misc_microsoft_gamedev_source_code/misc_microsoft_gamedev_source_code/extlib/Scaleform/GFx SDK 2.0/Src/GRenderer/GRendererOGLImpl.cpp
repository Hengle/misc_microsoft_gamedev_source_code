...
public:
    ...
    public:
        ...
        void    Apply(GRendererOGLImpl *prenderer) const
        {
            ...
            if (Mode == FM_Color)
            {
                prenderer->ApplyColor(Color, prenderer->RenderMode & GViewport::View_AlphaComposite);
            ...
            {
                if ((prenderer->RenderMode & GViewport::View_AlphaComposite) && Fill.pTexture == NULL)
                    prenderer->ApplyColor(Color, 1);
                else
...

    {
        ...
        glBlendFunc(viewport.Flags & GViewport::View_AlphaComposite ? GL_ONE : GL_SRC_ALPHA, 
        ...
        if (backgroundColor.GetAlpha() > 0)
        {
            ...
            ApplyColor(backgroundColor, RenderMode & GViewport::View_AlphaComposite);
    ...
    // Blending into alpha textures with premultiplied colors
        ...
        {
            { GL_FUNC_ADD,              GL_ONE,        GL_ONE,        GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // None
            { GL_FUNC_ADD,              GL_ONE,        GL_ONE,        GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // Normal
            { GL_FUNC_ADD,              GL_ONE,        GL_ONE,        GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // Layer

            { GL_FUNC_ADD,              GL_DST_COLOR,  GL_DST_ALPHA,  GL_SRC_ALPHA,           GL_ZERO                 }, // Multiply

            { GL_FUNC_ADD,              GL_ONE,        GL_ONE,        GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // Screen *??

            { GL_MAX,                   GL_SRC_ALPHA,  GL_SRC_ALPHA,  GL_ONE,                 GL_ONE                  }, // Lighten *??
            { GL_MIN,                   GL_SRC_ALPHA,  GL_SRC_ALPHA,  GL_ONE,                 GL_ONE                  }, // Darken *??

            { GL_FUNC_ADD,              GL_ONE,        GL_ONE,        GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // Difference

            { GL_FUNC_ADD,              GL_ONE,        GL_DST_ALPHA,  GL_ONE,                 GL_ONE                  }, // Add
            { GL_FUNC_REVERSE_SUBTRACT, GL_ONE,        GL_DST_ALPHA,  GL_ONE,                 GL_ONE                  }, // Subtract

            { GL_FUNC_ADD,              GL_SRC_ALPHA,  GL_SRC_ALPHA,  GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // Invert *??

            { GL_FUNC_ADD,              GL_ONE,        GL_ONE,        GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // Alpha *??
            { GL_FUNC_ADD,              GL_SRC_ALPHA,  GL_SRC_ALPHA,  GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // Erase *??
            { GL_FUNC_ADD,              GL_SRC_ALPHA,  GL_SRC_ALPHA,  GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // Overlay *??
            { GL_FUNC_ADD,              GL_SRC_ALPHA,  GL_SRC_ALPHA,  GL_ONE_MINUS_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA  }, // HardLight *??
        };
    ...
    void ApplyColor(const GColor c, int alpha = 0)
    {
        if (alpha)
        {
                ...
                (BlendMode == Blend_Darken))
            {
                ...
                glColor4f (alpha * gflerp(1.0f, c.GetRed() * mult, alpha),
                           alpha * gflerp(1.0f, c.GetGreen() * mult, alpha),
                           alpha * gflerp(1.0f, c.GetBlue() * mult, alpha), alpha);
            }
            else
            {
            ...
            (BlendMode == Blend_Darken))
        {
            ...
            glColor4f (gflerp(1.0f, c.GetRed() * mult, alpha),
                       gflerp(1.0f, c.GetGreen() * mult, alpha),
                       gflerp(1.0f, c.GetBlue() * mult, alpha), alpha);
        }
        else
