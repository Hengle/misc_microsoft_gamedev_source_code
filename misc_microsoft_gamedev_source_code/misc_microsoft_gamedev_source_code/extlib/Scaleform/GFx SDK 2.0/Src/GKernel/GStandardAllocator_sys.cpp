...
bool    GStandardAllocator::AllocBlock(UInt index)
{
    ...
    if (pmem)
    {
        ...
        Header *pmemHeader = (Header*)
                 (((UByte*)pmem) + sizeof(void*) - sizeof(Header));
...
void    GStandardAllocator::FreeBlock(Node *pnode)
{
    ...
    pBlockAllocator->FreeAligned(((UByte*)pnode) - sizeof(void*));
}
...
void*   GStandardAllocator::AllocImpl(UPInt usize, UPInt align, UPInt extra)
{
    ...
    {    
        if (align > 4096)
        {
            ...
            {       
                ...
                Stats.AllocSize     += usize+extra - sizeof(UPInt);
                *((UPInt*)pret) = usize+extra - sizeof(UPInt);
                pret = ((UPInt*)pret)+1;
                return pret;
            }
            return 0;
    ...
    Stats.AllocSize     += size - sizeof(UPInt);
    *((UPInt*)pret) = size - sizeof(UPInt);
    pret = ((UPInt*)pret)+1;
#endif
...
void*   GStandardAllocator::AllocAligned(UPInt size, UPInt align, UPInt extra)
{
    ...
    return AllocImpl(size, align, extra);
}
