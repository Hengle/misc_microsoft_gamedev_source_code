...
GASIntervalTimer::GASIntervalTimer(const GASFunctionRef& function, GASStringContext* psc) :
    Function(function), MethodName(psc->GetBuiltin(GASBuiltin_empty_)), Interval(0), InvokeTime(0), Id(0), Active(true)
{
    // Note: ignore 
}

GASIntervalTimer::GASIntervalTimer(GASObject* object, const GASString& methodName) :
    Object(object), MethodName(methodName), Interval(0), InvokeTime(0), Id(0), Active(true)
{
}

GASIntervalTimer::GASIntervalTimer(GFxASCharacter* character, const GASString& methodName) :
    Character(character), MethodName(methodName), Interval(0), InvokeTime(0), Id(0), Active(true)
{
}
