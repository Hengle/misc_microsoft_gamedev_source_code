...
#define GFXLOG_MESSAGE_FUNC_DECL(name, message_type) inline void   name(const char* pfmt, ...) const GFXLOG_VAARG_ATTRIBUTE;

#define GFXLOG_MESSAGE_FUNC(name, message_type)                                                                 \
    template <class Derived>                                                                                    \
    inline void GFxLogBase<Derived>::name(const char* pfmt, ...) const                                         \
