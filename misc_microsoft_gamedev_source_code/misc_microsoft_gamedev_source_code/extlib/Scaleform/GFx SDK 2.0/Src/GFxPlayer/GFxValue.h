...
public:
    ...
    void    SetInt(int val)                     { SetNumber(GASNumber(val)); }
	void    SetUInt(UInt val)                   { SetNumber(GASNumber(val)); }
    ...
    bool    GetPropertyValue(GASEnvironment* penv, GASObjectInterface* pthis, GASValue* value);
