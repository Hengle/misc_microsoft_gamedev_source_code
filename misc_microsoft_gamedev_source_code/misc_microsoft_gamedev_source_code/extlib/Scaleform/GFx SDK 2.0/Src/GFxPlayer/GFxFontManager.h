...
public:
    ...
    GFxFontHandle(GFxFontManager *pmanager, GFxFontResource *pfont,
                  const char* pfontName = 0, UInt deviceFontFlag = 0,
                  GFxMovieDef* pdefImpl = 0)
        : RefCount(1), pFontManager(pmanager), DeviceFontFlag(deviceFontFlag),
          pFont(pfont), pSourceMovieDef(pdefImpl)
    {
    ...
    {
        return GetFont()->GetFontFlags() | DeviceFontFlag;
    }
...
protected:
    ...
    struct NodePtr
    {
        ...
        bool operator == (const NodePtr& other) const
        {
            ...
            enum { FontFlagsMask = GFxFont::FF_CreateFont_Mask | GFxFont::FF_DeviceFont };
    ...
    {                
        ...
        {            
            ...
            return (size_t) FontKey::CalcHashCode(pfontName, gfc_strlen(pfontName), pnode->pFont->GetFontFlags());
        }
