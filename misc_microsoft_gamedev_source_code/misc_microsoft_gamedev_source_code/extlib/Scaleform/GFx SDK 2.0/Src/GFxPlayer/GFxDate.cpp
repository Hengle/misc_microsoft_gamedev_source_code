...
void GASDateCtorFunction::GlobalCtor(const GASFnCall& fn)
{
    ...
    else
    {
        ...
        DateObj->SetDate(SInt64(s) * 1000 + SInt64(ns/1000000));
#elif defined(GFC_OS_PSP)
        // TODO: implement time using sceRtc functions
#elif defined(GFC_OS_WII)
        // TODO: implement time on Wii console
#elif defined(GFC_CC_RENESAS) && defined(DMP_SDK)
        DateObj->LocalOffset = 0;
        ...
        struct timezone tz;
        gettimeofday(&tv, &tz);
        DateObj->LocalOffset = 60000 * tz.tz_minuteswest;
