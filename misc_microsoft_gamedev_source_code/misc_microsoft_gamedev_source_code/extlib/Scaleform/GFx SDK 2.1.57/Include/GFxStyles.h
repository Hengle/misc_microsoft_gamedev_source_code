...
//class GFxBaseFillStyle : public GNewOverrideBase ??? Is it redundant?
//{
//public:
...
class GFxFillStyle : public GNewOverrideBase //public GFxBaseFillStyle
{
public:
    GFxFillStyle();
    ...
    void            Apply(const GFxDisplayContext& dc,
    ...
    bool            IsClippedImageFill() const  { return  Type == GFxFill_ClippedSmoothImage || Type == GFxFill_ClippedImage; }
    bool            IsTiledImageFill() const    { return  Type == GFxFill_TiledSmoothImage || Type == GFxFill_TiledImage; }
    ...
    const GRenderer::Matrix& GetImageMatrix() const { return ImageMatrix; }
    ...
    void            SetImageMatrix(const GRenderer::Matrix& mtx)
    {
        ImageMatrix = mtx;
    }
