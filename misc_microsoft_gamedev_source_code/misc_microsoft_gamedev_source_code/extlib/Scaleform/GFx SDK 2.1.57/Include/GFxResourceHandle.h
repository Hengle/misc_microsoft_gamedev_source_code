...
private:
    ...
    // so that we can AddRef to the resource without GFxMovieDefImpl decl.
    union {
        GFxResource*                    pOwnerDefRes;
...
public:
    ...
    // generates a warning in GFxMovieDefImpl initializer list.
    void SetOwnerDefImpl(class GFxMovieDefImpl* powner)
    { GLock::Locker lock(&ResourceLock); pOwnerDefImpl = powner; }
    ...
    class GFxMovieDefImpl* GetOwnerDefImplAddRef() const
    {
