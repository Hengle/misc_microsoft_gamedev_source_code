...
// If not in debug build, macros do nothing
    ...
    #define GFC_DEBUG_ASSERT(cond, str)                                     ((void)0)
    #define GFC_DEBUG_ASSERT1(cond, str, p1)                                ((void)0)
    #define GFC_DEBUG_ASSERT2(cond, str, p1, p2)                            ((void)0)
    #define GFC_DEBUG_ASSERT3(cond, str, p1, p2, p3)                        ((void)0)
    #define GFC_DEBUG_ASSERT4(cond, str, p1, p2, p3, p4)                    ((void)0)
    #define GFC_DEBUG_ASSERT5(cond, str, p1, p2, p3, p4, p5)                ((void)0)
    #define GFC_DEBUG_ASSERT6(cond, str, p1, p2, p3, p4, p5, p6)            ((void)0)
