...
public:
    ...
    template <class T> 
    static UInt8    Cardinality(T v);

    // Return number of bits required to represent the value
    GINLINE static UInt8 BitCount32(UInt32 value);
};

template <class T>
UInt8 GBitsUtil::Cardinality(T v)
{
...
GINLINE UInt8 GBitsUtil::BitCount32(UInt32 value)
{
