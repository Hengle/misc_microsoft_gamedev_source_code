...
toggle_stats:
        ...
        case FxApp::O:
            ...
            /*
        case 'V':
            Settings.VMCFlags = (Settings.VMCFlags & ~FXPLAYER_RENDER::VMConfig_UseDynamicTex) |
                ((~(Settings.VMCFlags & FXPLAYER_RENDER::VMConfig_UseDynamicTex)) & FXPLAYER_RENDER::VMConfig_UseDynamicTex);
            pRenderTexture = 0;
            pStencilSurface = 0;
