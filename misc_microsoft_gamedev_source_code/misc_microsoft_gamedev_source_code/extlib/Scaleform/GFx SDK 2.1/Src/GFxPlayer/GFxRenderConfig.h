...
public:
    ...
    {       
        ...
        RF_StrokeNormal         = 0x00,         // Fast GFx anisotropic stroking for Normal strokes.
        RF_StrokeCorrect        = 0x01,         // Flash compatible stroking, expensive to scale/rotate.
        RF_StrokeHairline       = 0x02,         // Outline only.
        RF_StrokeMask           = 0x03,

		//Dynamic Tessellation?
		RF_Dynamic_Tessellation = 0x04,
	...
	inline bool			DoDynamicTessellation() const		{ return (RenderFlags & RF_Dynamic_Tessellation) != 0; }
