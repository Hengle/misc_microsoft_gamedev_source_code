...
class GFxActionLogger : public GFxLogBase<GFxActionLogger>
{
    ...
    char*       LogSuffix; 
public:         
    GFxActionLogger(GFxCharacter *ptarget, const GFxString& suffixStr ="" );
...
public:
    ...
    bool    GetVariable(const GASString& varname, GASValue* presult, const GTL::garray<GASWithStackEntry>* pwithStack = NULL, 
                        GFxASCharacter **ppnewTarget = 0, GASValue* powner = 0, UInt excludeFlags = 0) const;
    ...
    bool    GetVariableRaw(const GASString& varname, GASValue* presult, const GTL::garray<GASWithStackEntry>* pwithStack = NULL,
                           GASValue* powner = 0, UInt excludeFlags = 0) const;
