...
class hkpWorldRayCaster : public hkpBroadPhaseCastCollector
{
	public:
		...
		~hkpWorldRayCaster(){}
			...
			/// For each narrow phase object the ray hits, the hkpWorldRayCastOutput receives a callback
		void castRay( const hkpBroadPhase& broadphase, const hkpWorldRayCastInput& input, const hkpCollisionFilter* filter, hkpRayHitCollector& collector );
