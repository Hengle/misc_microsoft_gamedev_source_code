...
const hkTransform& hkpCdBody::getTransform() const
{
	...
	return *static_cast<const hkTransform*>(m_motion.val());
}

const hkMotionState* hkpCdBody::getMotionState() const
{
	return static_cast<const hkMotionState*>(m_motion.val());
}
...
{	
	...
	//const hkpCollidable* coll = reinterpret_cast<const hkpCollidable*>(body);
