...
class hkpContactMgr: public hkReferencedObject	
{
	public:
		...
		HK_FORCE_INLINE void removeToi( const hkpCollidable& a, const hkpCollidable& b, class hkCollisionConstraintOwner& constraintOwner, hkpContactPointProperties& properties );
	...
	public:
		...
		virtual void removeToiImpl( const hkpCollidable& a, const hkpCollidable& b, class hkCollisionConstraintOwner& constraintOwner, hkpContactPointProperties& properties ) = 0;
