...
inline const hkVector4&	hkpExtendedMeshShape::getScaling() const
{
	return m_scaling;
}


inline hkpExtendedMeshShape::Subpart::Subpart(SubpartType type)
{
	m_type = type;
...
inline hkpExtendedMeshShape::TrianglesSubpart::TrianglesSubpart(): Subpart( SUBPART_TRIANGLES )
{
