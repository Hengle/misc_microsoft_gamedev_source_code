...
// Generated from 'Physics/Dynamics/Constraint/Bilateral/rotational/hkpRotationalConstraintData.h'
...
//
HK_REFLECTION_DEFINE_SCOPED_NONVIRTUAL(hkpRotationalConstraintData,Atoms);
...
//
HK_REFLECTION_DEFINE_VIRTUAL(hkpRotationalConstraintData);
static const hkInternalClassMember hkpRotationalConstraintDataClass_Members[] =
{
	{ "atoms", &hkpRotationalConstraintDataAtomsClass, HK_NULL, hkClassMember::TYPE_STRUCT, hkClassMember::TYPE_VOID, 0, 0|hkClassMember::ALIGN_16, HK_OFFSET_OF(hkpRotationalConstraintData,m_atoms), HK_NULL }
};
