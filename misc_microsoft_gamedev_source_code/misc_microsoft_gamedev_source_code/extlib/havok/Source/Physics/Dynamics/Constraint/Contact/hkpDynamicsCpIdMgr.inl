...
#	include <Common/Base/Container/ArraySpu/hkArraySpu.h>
	extern hkArraySpu* g_cpIdMgrValuesArrayOnSpu;
#	define M_VALUE_GET_SIZE() g_cpIdMgrValuesArrayOnSpu->getSize()
#	define M_VALUE_GET_VALUE(IDX) ( g_cpIdMgrValuesArrayOnSpu->getValueAt<hkpValueType>(IDX) )
...
inline hkpDynamicsCpIdMgr::hkpValueType hkpDynamicsCpIdMgr::getValueAt(int id)
{
