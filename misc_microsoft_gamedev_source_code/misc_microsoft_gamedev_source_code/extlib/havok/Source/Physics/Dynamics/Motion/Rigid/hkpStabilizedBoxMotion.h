...
class hkpStabilizedBoxMotion : public hkpBoxMotion 
{
	//+vtable(1)
	public:
		...
		hkpStabilizedBoxMotion(const hkVector4& position, const hkQuaternion& rotation);

	public:

		hkpStabilizedBoxMotion( class hkFinishLoadedObjectFlag flag ) : hkpBoxMotion( flag ) {}
};
