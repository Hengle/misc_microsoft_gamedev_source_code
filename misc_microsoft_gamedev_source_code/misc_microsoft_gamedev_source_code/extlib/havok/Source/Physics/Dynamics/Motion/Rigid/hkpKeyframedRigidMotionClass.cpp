...
// Generated from 'Physics/Dynamics/Motion/Rigid/hkpKeyframedRigidMotion.h'
...
//
HK_REFLECTION_DEFINE_VIRTUAL(hkpKeyframedRigidMotion);
...
//
HK_REFLECTION_DEFINE_VIRTUAL(hkpMaxSizeMotion);
