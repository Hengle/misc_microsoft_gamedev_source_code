...
class hkpWorldAgentUtil
{
	public:
		...
		static void HK_CALL invalidateTim( hkpEntity* entity, hkpCollisionInput& collisionInput );

			/// ###ACCESS_CHECKS###( [island->m_world,HK_ACCESS_RO] [island,HK_ACCESS_RW] );
		static void HK_CALL warpTime( hkpSimulationIsland* island, hkTime oldTime, hkTime newTime, hkpCollisionInput& collisionInput );
};
