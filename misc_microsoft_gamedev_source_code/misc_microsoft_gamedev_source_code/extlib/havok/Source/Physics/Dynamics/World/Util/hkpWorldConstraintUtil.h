...
class hkpWorldConstraintUtil
{
	public:
		...
		static void                      HK_CALL removeModifier          ( hkpConstraintInstance* instance, hkpConstraintOwner& constraintOwner, hkpConstraintAtom::AtomType type );
		...
		static hkpModifierConstraintAtom* HK_CALL findModifier            ( hkpConstraintInstance* instance, hkpConstraintAtom::AtomType type );
			/// ###ACCESS_CHECKS###( [world,HK_ACCESS_IGNORE] [instance->getSimulationIsland(),HK_ACCESS_RO] );
