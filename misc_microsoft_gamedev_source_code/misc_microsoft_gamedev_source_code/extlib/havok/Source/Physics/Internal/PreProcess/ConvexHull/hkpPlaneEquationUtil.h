...
///
class hkpPlaneEquationUtil
{
	public:

		struct IntersectionPoint
		{
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_GEOMETRY, hkpPlaneEquationUtil::IntersectionPoint );
		...
		struct VisitedEdge
		{
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_GEOMETRY, hkpPlaneEquationUtil::VisitedEdge );
		...
		{
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_GEOMETRY, hkpPlaneEquationUtil::hkpPlaneEqnIndexPair );
