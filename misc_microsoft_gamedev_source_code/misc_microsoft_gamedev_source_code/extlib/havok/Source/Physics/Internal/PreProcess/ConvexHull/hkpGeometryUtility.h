...
public:
	...
	static void HK_CALL createConvexGeometry( const hkStridedVertices& stridedVertsIn, hkGeometry& geometryOut, hkpGeomConvexHullMode mode = HK_GEOM_CONVEXHULL_MODE_FAST );
	...
	static void HK_CALL createConvexGeometry( const hkStridedVertices& stridedVertsIn, hkGeometry& geometryOut, hkArray<hkVector4>& planeEquationsOut, hkpGeomConvexHullMode mode = HK_GEOM_CONVEXHULL_MODE_FAST );
	...
	static void HK_CALL calcObb( const hkStridedVertices& stridedVertsIn, hkVector4& halfExtents, hkTransform& transform, hkpGeomObbMode mode = HK_GEOM_OBB_MODE_DEFAULT);
