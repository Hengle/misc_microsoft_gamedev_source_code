...
extern "C"
{
	...
	//void HK_CALL hkAgentNnMachine_CreateTrack( hkpAgentNnTrack& track );

	void HK_CALL hkAgentNnMachine_DestroyTrack( hkpAgentNnTrack& track, hkpCollisionDispatcher* dispatch );

	void HK_CALL hkAgentNnMachine_GetAgentType( hkpCollidable* collA, hkpCollidable* collB, const hkpProcessCollisionInput& input, int& agentTypeOut, int& isFlippedOut );

	hkpAgentNnEntry* HK_CALL hkAgentNnMachine_CreateAgent( hkpAgentNnTrack& track, hkpLinkedCollidable* collA, hkpLinkedCollidable* collB, int agentType, const hkpProcessCollisionInput& input, hkpContactMgr* mgr);
	...
	hkpAgentNnEntry* HK_CALL hkAgentNnMachine_FindAgent( hkpLinkedCollidable* collA, hkpLinkedCollidable* collB );


		// activation/deactiation/setPositionOnEntity
	void HK_CALL hkAgentNnMachine_InvalidateTimInAgent( hkpAgentNnEntry* entry, hkpCollisionInput& input );

	void HK_CALL hkAgentNnMachine_WarpTimeInAgent( hkpAgentNnEntry* entry, hkTime oldTime, hkTime newTime, hkpCollisionInput& input );
