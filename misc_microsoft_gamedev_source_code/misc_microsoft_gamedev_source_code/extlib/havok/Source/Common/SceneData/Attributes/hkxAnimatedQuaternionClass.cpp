...
// Generated from 'Common/SceneData/Attributes/hkxAnimatedQuaternion.h'
...
//
HK_REFLECTION_DEFINE_SIMPLE(hkxAnimatedQuaternion);
static const hkInternalClassMember hkxAnimatedQuaternionClass_Members[] =
{
	{ "quaternions", HK_NULL, HK_NULL, hkClassMember::TYPE_SIMPLEARRAY, hkClassMember::TYPE_QUATERNION, 0, 0, HK_OFFSET_OF(hkxAnimatedQuaternion,m_quaternions), HK_NULL }
};
