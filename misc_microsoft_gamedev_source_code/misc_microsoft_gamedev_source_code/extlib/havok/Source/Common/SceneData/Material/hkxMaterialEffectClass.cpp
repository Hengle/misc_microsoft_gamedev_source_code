...
//
HK_REFLECTION_DEFINE_SIMPLE(hkxMaterialEffect);
static const hkInternalClassMember hkxMaterialEffectClass_Members[] =
{
	{ "name", HK_NULL, HK_NULL, hkClassMember::TYPE_CSTRING, hkClassMember::TYPE_VOID, 0, 0, HK_OFFSET_OF(hkxMaterialEffect,m_name), HK_NULL },
	...
	{ "data", HK_NULL, HK_NULL, hkClassMember::TYPE_SIMPLEARRAY, hkClassMember::TYPE_UINT8, 0, 0, HK_OFFSET_OF(hkxMaterialEffect,m_data), HK_NULL }
};
