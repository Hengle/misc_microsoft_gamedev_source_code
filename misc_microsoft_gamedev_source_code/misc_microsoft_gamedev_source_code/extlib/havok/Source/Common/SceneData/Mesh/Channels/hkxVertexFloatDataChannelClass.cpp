...
//
HK_REFLECTION_DEFINE_SIMPLE(hkxVertexFloatDataChannel);
static const hkInternalClassMember hkxVertexFloatDataChannelClass_Members[] =
{
	{ "perVertexFloats", HK_NULL, HK_NULL, hkClassMember::TYPE_SIMPLEARRAY, hkClassMember::TYPE_REAL, 0, 0, HK_OFFSET_OF(hkxVertexFloatDataChannel,m_perVertexFloats), HK_NULL }
};
