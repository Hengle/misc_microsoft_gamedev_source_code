...
#	include <semaphore.h>
#endif
#if (defined(HK_PLATFORM_MACPPC) || defined(HK_PLATFORM_MAC386) || defined(HK_PLATFORM_UNIX)) && (HK_CONFIG_THREAD == HK_CONFIG_MULTI_THREADED)
#	include <pthread.h>
#endif
...
#elif defined(HK_SIMULATE_SPU_DMA_ON_CPU) // spu simulator
