...
#ifndef HK_PLATFORM_PS3SPU // This constructor causes the compiler NOT to pass const hkVector4's by register.
...
#define HKVECTOR4(A) (*reinterpret_cast<const hkVector4*>(&A))
