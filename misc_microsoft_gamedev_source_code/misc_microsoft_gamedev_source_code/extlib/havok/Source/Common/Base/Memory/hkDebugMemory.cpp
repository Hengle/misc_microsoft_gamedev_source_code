...
#if (defined(HK_PLATFORM_GC) && defined(HK_COMPILER_GCC)) || (defined(HK_PLATFORM_PS2) && defined(HK_COMPILER_GCC))

#include <Common/Base/Memory/Memory/Debug/hkDebugMemory.h>

hkDebugMemory* hkDebugMemory::create()
{
	return HK_NULL;
}
