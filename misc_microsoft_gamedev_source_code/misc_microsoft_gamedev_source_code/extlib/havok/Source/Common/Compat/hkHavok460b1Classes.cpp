...
namespace hkHavok460b1Classes
{
	const char VersionString[] = "Havok-4.6.0-b1";
	...
	static hkInternalClassMember hkExtendedMeshShape_TrianglesSubpartClass_Members[] =
	{
		...
		{ "pad", HK_NULL, HK_NULL, hkClassMember::TYPE_INT32, hkClassMember::TYPE_VOID, 0, 0, 0, HK_NULL }
	};
	namespace
	{
		...
		{
			{-1,-1,-1,-1,-1,-1,-1,-1,HK_OFFSET_OF(hkExtendedMeshShapeTrianglesSubpart_DefaultStruct,m_triangleOffset),-1},
			-1
		};
	}
	...
	static hkInternalClassMember hkExtendedMeshShape_ShapesSubpartClass_Members[] =
	{
		...
		{ "transform", HK_NULL, HK_NULL, hkClassMember::TYPE_TRANSFORM, hkClassMember::TYPE_VOID, 0, 0, 0, HK_NULL },
		{ "pad", HK_NULL, HK_NULL, hkClassMember::TYPE_INT32, hkClassMember::TYPE_VOID, 4, 0, 0, HK_NULL }
	};
