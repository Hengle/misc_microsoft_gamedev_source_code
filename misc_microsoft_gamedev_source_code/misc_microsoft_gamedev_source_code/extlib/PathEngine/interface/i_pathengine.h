...
const long PATHENGINE_INTERFACE_MINOR_VERSION = 47;
...
public:
    ...
    virtual void getRepresentedRegionsOverlapped(long minX, long minY, long maxX, long maxY, long* resultsBuffer, long& numberOverlapped) const = 0;
    void operator delete(void* voidPointer)
    {
        if(voidPointer)
        {
...
public:
    ...
    void
    updateProgressL(const char* operationDescription, long i, long totalI)
    {
