...
//
//////////////////////////////////////////////////////////////////////
#ifndef _ACTION_SET_LPF_H_
#define _ACTION_SET_LPF_H_
...
class CAkActionSetLPF : public CAkActionSetValue
{
public:
	//Thread safe version of the constructor
	static CAkActionSetLPF* Create(AkActionType in_eActionType, AkUniqueID in_ulID = 0);
...
protected:
	//Constructor
	CAkActionSetLPF(AkActionType in_eActionType, AkUniqueID in_ulID);

	//Destructor
	virtual ~CAkActionSetLPF();
