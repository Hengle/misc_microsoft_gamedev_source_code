...
STATIC CHAR DebugFileLocation[]="C:\\Temp\\";
#else
STATIC CHAR DebugFileLocation[]="E:\\";
#endif
...
#if !ENABLE_DEBUG_FILE && !ENABLE_OUTPUT_DEBUG_STRING
   return;
#endif	
...
VOID Failure(CONST char *Message,BOOLEAN Report )
	{
	//
