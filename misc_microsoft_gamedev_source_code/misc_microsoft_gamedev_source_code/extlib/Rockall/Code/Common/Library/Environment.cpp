...
#endif
SBIT16 ENVIRONMENT::NumberOfProcessors = 1; //prefix simulations require a legal value
...
ENVIRONMENT::ENVIRONMENT( VOID )
    ...
    if ( AtomicIncrement( & Activations ) == 1 )
		...
		AllocationGranularity=GetLargePageMinimum();
#else
...
#else
		AllocationGranularity = 0x1000;
#endif
		SizeOfPage = 0x1000;
#ifdef _XENON
		SizeOfMemory = 	0x20000000;
		NumberOfProcessors = 6;
#elif _XBOX
		SizeOfMemory = 	0x4000000;
