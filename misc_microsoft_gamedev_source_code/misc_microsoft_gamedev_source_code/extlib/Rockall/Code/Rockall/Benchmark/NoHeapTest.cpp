...
NO_HEAP_TEST::NO_HEAP_TEST( VOID )
	{
	Active = False;
	MaxThreads = 0;
	ZeroAll = False;
...
BOOLEAN NO_HEAP_TEST::CreateHeaps
		( 
...
CHAR *NO_HEAP_TEST::NameOfHeap( VOID )
	{ return ((CHAR*) "Overhead calculation (No heap)" ); }
...
VOID NO_HEAP_TEST::DeleteHeaps( VOID )
	{
	//
