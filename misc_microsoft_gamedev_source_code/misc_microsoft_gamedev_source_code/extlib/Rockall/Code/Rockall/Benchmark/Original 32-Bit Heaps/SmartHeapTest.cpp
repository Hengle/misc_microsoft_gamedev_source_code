...
#include "../../../Build/SmartHeap/Include/ShMalloc.h"
    ...
    /********************************************************************/
    /*                                                                  */
    /*   Smart heap configuration.                                      */
    /*                                                                  */
    /*   Configure smart heap.                                          */
    /*                                                                  */
    /********************************************************************/
...
SMART_HEAP_TEST::SMART_HEAP_TEST( VOID )
	{
	Active = False;
	MaxThreads = 0;
	ZeroAll = False;
...
BOOLEAN SMART_HEAP_TEST::CreateHeaps
		( 
	...
	if ( (! Active) && (NumberOfHeaps > 0) && (NumberOfThreads > 0) )
		...
		//
		Heaps = ((SMRTHEAP*) malloc( (NumberOfHeaps * sizeof(SMRTHEAP)) ));
...
CHAR *SMART_HEAP_TEST::NameOfHeap( VOID )
	{ return ((CHAR*) "SmartHeap (Standard heap)" ); }
...
VOID SMART_HEAP_TEST::DeleteHeaps( VOID )
	{
	//
