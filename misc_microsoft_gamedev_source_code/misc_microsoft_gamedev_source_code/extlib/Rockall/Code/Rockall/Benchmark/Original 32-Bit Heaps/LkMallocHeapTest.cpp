...
#include "../../../Build/LkHeap/Include/LkMalloc.h"
#include "LkMallocHeapTest.hpp"
...
LKMALLOC_HEAP_TEST::LKMALLOC_HEAP_TEST( VOID )
	{
	Active = False;
	MaxThreads = 0;
	ZeroAll = False;
...
BOOLEAN LKMALLOC_HEAP_TEST::CreateHeaps
		( 
...
VOID LKMALLOC_HEAP_TEST::Delete
		( 
		VOID						  *Address,
		SBIT32						  Thread
		)
...
CHAR *LKMALLOC_HEAP_TEST::NameOfHeap( VOID )
	{ return ((CHAR*) "LkMalloc Heap (Standard heap - Multiple Caches)" ); }
...
VOID LKMALLOC_HEAP_TEST::Resize
		( 
		VOID						  **Address,
		SBIT32						  NewSize,
		SBIT32						  Thread
...
VOID LKMALLOC_HEAP_TEST::DeleteHeaps( VOID )
	{
	//
