...
#define MAXSTACKFRAMES 16
    ...
    /*   raises an exception at the point it detects a problem.         */
    /*                                                                  */
    /********************************************************************/
...
class ROCKALL_DLL_LINKAGE DEBUG_HEAP : public ROCKALL
{
        ...
        //
        // this member's set based on an env. var CSReportLeaks
        // basically m_bReportLeaks = (CSReportLeaks == 1);
        //
        bool m_bReportLeaks;
    public:
        //
