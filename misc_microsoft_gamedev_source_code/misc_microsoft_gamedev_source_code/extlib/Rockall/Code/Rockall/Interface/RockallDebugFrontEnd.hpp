...
//const int MaxFunctions				  = 10;
// rg [2/17/07] - Setting this to 1 because we don't use Rockall's stack trace features, 
// and because the header struct was 64-bytes!
const int MaxFunctions				  = 1;
...
class ROCKALL_DLL_LINKAGE ROCKALL_DEBUG_FRONT_END : public ROCKALL_FRONT_END
	...
	protected:
		...
		virtual void UserError( void *Address,void *Header,const char *Message ) = 0;
