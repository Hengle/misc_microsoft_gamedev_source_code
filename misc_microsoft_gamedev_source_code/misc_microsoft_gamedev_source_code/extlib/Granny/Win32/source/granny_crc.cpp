// ========================================================================
// $File: //jeffr/granny/rt/granny_crc.cpp $
...
//
// This is a standard 32-bit CRC table.  Originally I thought it was
...
void GRANNY
AddToCRC32(uint32 &CRC, uint32 Count, void const *UInt8sInit)
{
    uint8 const *UInt8s = (uint8 const *)UInt8sInit;

    while(Count--)
    {
        CRC = CRC32Table[((int32)CRC ^ (*UInt8s++)) & 0xFF] ^ (CRC >> 8);
    }
}
