...
// ========================================================================
// $File: //jeffr/granny/rt/granny_math_inlines.h $
...
#elif PROCESSOR_CELL_SPU
  #include <vectormath/cpp/vectormath_aos.h>
  #include <spu_intrinsics_gcc.h>
#else
  #error "PS3 platform must set PROCESSOR_CELL or PROCESSOR_CELL_SPU"
#endif
#endif
