...
{
   *LocalClock = Control.LocalClock;
   *CurrentClock = Control.CurrentClock;
   *dtLocalClockPending = Control.dTLocalClockPending;
   *LoopIndex = Control.LoopIndex;
}
...
SetControlClockValues(control &Control, real32 LocalClock, real32 CurrentClock, real32 dtLocalClockPending, int32x LoopIndex)
{
   ...
   Control.CurrentClock = CurrentClock;
   Control.dTLocalClockPending = dtLocalClockPending;
