...
GRANNY_DYNLINK(void) GrannyGetControlClockValues(granny_control const * Control, granny_real32* LocalClock, granny_real32* CurrentClock, granny_real32* dtLocalClockPending, granny_int32x* LoopIndex)
{
   GetControlClockValues((control const &)*Control, (real32*)LocalClock, (real32*)CurrentClock, (real32*)dtLocalClockPending, (int32x*)LoopIndex);
}

GRANNY_DYNLINK(void) GrannySetControlClockValues(granny_control * Control, granny_real32 LocalClock, granny_real32 CurrentClock, granny_real32 dtLocalClockPending, granny_int32x LoopIndex)
{
   SetControlClockValues((control &)*Control, (real32)LocalClock, (real32)CurrentClock, (real32)dtLocalClockPending, (int32x)LoopIndex);
}
