...
EXPAPI GS_PARAM void GetControlClockValues(control const &Control, real32* LocalClock, real32* CurrentClock, real32* dtLocalClockPending, int32x* LoopIndex);
EXPAPI GS_PARAM void SetControlClockValues(control &Control, real32 LocalClock, real32 CurrentClock, real32 dtLocalClockPending, int32x LoopIndex);
