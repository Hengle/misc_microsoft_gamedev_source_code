...
#ifndef CAK_DEFAULT_LOW_LEVEL_IO_H
#define CAK_DEFAULT_LOW_LEVEL_IO_H

#include <AK/SoundEngine/Common/IAkStreamMgr.h>
#include <AK/SoundEngine/Platforms/XBox360/AkStreamMgrModule.h>

//-----------------------------------------------------------------------------
// Name: class CAkDefaultLowLevelIO.
...
//-----------------------------------------------------------------------------
class CAkDefaultLowLevelIO : public AK::IAkLowLevelIO
{
public:

    CAkDefaultLowLevelIO( );
    virtual ~CAkDefaultLowLevelIO( );
...
#endif //CAK_DEFAULT_LOW_LEVEL_IO_H