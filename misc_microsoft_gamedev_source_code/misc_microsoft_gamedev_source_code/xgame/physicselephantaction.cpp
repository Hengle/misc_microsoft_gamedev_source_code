//============================================================================
// File: physicselephantaction.cpp
//  
...
*/
const float cHardpointFrontZ = 3.0f;
...
const float cTreadRaySeparationDistanceBack = 4.7f;
...
const float cTreadHardpointFrontZ = 0.3f;
const float cTreadHardpointFrontX = 5.0f;
const float cTreadHardpointBackZ = -5.2;
const float cTreadHardpointBackX = 5.0f;
...
float ElephantWrapUV(float value);


//============================================================================
//============================================================================
BPhysicsElephantAction::BPhysicsElephantAction(hkpRigidBody* body, BEntity* pEntity) :
   hkpUnaryAction( body ),
   mPrevTurning(0.0f),
   mReorient(true),
   mStayOnPath(false),
...
//============================================================================
//============================================================================
BPhysicsElephantAction::~BPhysicsElephantAction()
{
   if(mTrailDecal)
   {
...
//============================================================================
//============================================================================
void BPhysicsElephantAction::getTreadData(float& flTreadHeight, float& frTreadHeight, float& blTreadHeight, float& brTreadHeight,
...
//============================================================================
//============================================================================
void BPhysicsElephantAction::applyAction( const hkStepInfo& stepInfo )
{
   ...
   hkVector4 contactNormals[4];
   {
      ...
      mCurrentLeftTreadScroll = ElephantWrapUV(mCurrentLeftTreadScroll);
      ...
      mCurrentRightTreadScroll = ElephantWrapUV(mCurrentRightTreadScroll);
   }
...
//============================================================================
//============================================================================
void BPhysicsElephantAction::calcMovement(float& acceleration, float& turning, bool& atGoal, BSquadActionMove* pSMA)
{
   atGoal = false;
   mStayOnPath = true;
...
//============================================================================
void BPhysicsElephantAction::reorient(const hkStepInfo& stepInfo)
{
...
//============================================================================
// BPhysicsElephantAction::spawnPhysicsEventVisuals
//============================================================================
void BPhysicsElephantAction::spawnPhysicsEventVisuals(long terrainEffectsHandle)
{
...
//============================================================================
#ifndef BUILD_FINAL
   void BPhysicsElephantAction::debugRender()
   {
