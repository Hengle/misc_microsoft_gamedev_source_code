...
#define MAXVER_INTERNALNAME "objexp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "objexp.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Binary OBJ file exporter (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "Ensemble Studios\0"//should  be overidden on a per-dll level
