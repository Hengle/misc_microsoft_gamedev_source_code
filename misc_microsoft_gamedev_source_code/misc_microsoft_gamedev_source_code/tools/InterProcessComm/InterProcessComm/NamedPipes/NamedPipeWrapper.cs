...
namespace InterProcessComm.NamedPipes {
	...
	/// <see cref="InterProcessComm.NamedPipes.NamedPipeNative">NamedPipeNative</see> class
	...
	public sealed class NamedPipeWrapper {
		...
		/// <summary>
		/// Wait time for the 
		/// <see cref="InterProcessComm.NamedPipes.NamedPipeNative.WaitNamedPipe">NamedPipeNative.WaitNamedPipe</see> 
		/// operation.
		/// </summary>
		#endregion
		...
		/// <see cref="InterProcessComm.NamedPipes.NamedPipeWrapper.ReadBytes">InterProcessComm.NamedPipes.ReadBytes</see> 
		...
		/// <see cref="InterProcessComm.NamedPipes.NamedPipeWrapper.WriteBytes">InterProcessComm.NamedPipes.WriteBytes</see>
		...
		/// calling the <see cref="InterProcessComm.NamedPipes.NamedPipeWrapper.Connect">Connect</see>
