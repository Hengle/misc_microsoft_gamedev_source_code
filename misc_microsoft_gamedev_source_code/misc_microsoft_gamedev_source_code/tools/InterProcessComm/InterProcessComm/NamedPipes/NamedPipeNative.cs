...
namespace InterProcessComm.NamedPipes {
	...
	public sealed class NamedPipeNative {
		...
		/// <see cref="InterProcessComm.NamedPipes.SECURITY_ATTRIBUTES">SECURITY_ATTRIBUTES</see> 
		...
		/// <see cref="InterProcessComm.NamedPipes.Overlapped">Overlapped</see> object.</param>
		...
		/// <see cref="InterProcessComm.NamedPipes.SecurityAttributes">SecurityAttributes</see> 
