...
namespace InterProcessComm.NamedPipes {
	#region Comments
	/// <summary>
	...
	/// <see cref="InterProcessComm.NamedPipes.ClientPipeConnection">ClientPipeConnection</see> 
	/// and <see cref="InterProcessComm.NamedPipes.ServerPipeConnection">ServerPipeConnection</see> 
	...
	public abstract class APipeConnection : IInterProcessConnection {
		#region Comments
		/// <summary>
		/// A <see cref="InterProcessComm.NamedPipes.PipeHandle">PipeHandle</see> object containing
		...
		/// </summary>
		/// <remarks>
		/// See the <see cref="InterProcessComm.NamedPipes.NamedPipeWrapper.Read">NamedPipeWrapper.Read</see>
		...
		/// </summary>
		/// <remarks>
		/// See the <see cref="InterProcessComm.NamedPipes.NamedPipeWrapper.ReadBytes">NamedPipeWrapper.ReadBytes</see>
		/// method for an explanation of the message format.
		/// </remarks>
		...
		#region Comments
		/// <summary>
		/// Gets the pipe connection state from the <see cref="InterProcessComm.NamedPipes.PipeHandle">PipeHandle</see> 
		/// object.
		/// </summary>
