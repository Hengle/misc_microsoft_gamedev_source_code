...
DWORD Stripify( DWORD  dwNumTriangles,   // Number of triangles
                IndexType*  pTriangles,       // Ptr to triangle indices
                DWORD* pdwNumIndices,    // Number of output indices
                IndexType** ppStripIndices,   // Output indices
...
VOID ComputeVertexPermutation( DWORD  dwNumStripIndices,     // Number of strip indices
                               IndexType*  pStripIndices,         // Ptr to strip indices
                               DWORD  dwNumVertices,         // Number of vertices in
                               IndexType** ppVertexPermutation ); // Map from original index to remapped index
