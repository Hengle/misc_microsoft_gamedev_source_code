...
public:
    ...
    static DWORD GetSignedInUserCount() { return m_dwNumSignedInUsers; }
    static DWORD GetSignedInUserMask()  { return m_dwSignedInUserMask; }
    ...
    static DWORD GetSignedInUser() { return m_dwFirstSignedInUser; }

    // Check users that are signed into live
    static DWORD GetOnlineUserMask() { return m_dwOnlineUserMask; }
