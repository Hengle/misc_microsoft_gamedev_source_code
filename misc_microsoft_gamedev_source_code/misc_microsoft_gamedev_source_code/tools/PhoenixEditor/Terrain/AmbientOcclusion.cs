   ...
   public class AmbientOcclusion
   {
      ...
      public class DepthPeelTerrain
      {
         ...
         void loadShader()
         {
            ...
            mShaderPrevDepthTexture = ExportTo360.mExportTerrainRender.mTerrainGPUShader.getEffectParam("prevDepthTexture");
        ...
        //       s.Close();
         ...
         void generateNextDepthLayer(bool renderWorldObjects)
         {
            ...
            ExportTo360.mExportTerrainRender.mTerrainGPUShader.mShader.SetValue(mShaderPrevDepthTexture, mDepthBufferC);
         ...
         void renderTerrain()
         {
            ExportTo360.mExportTerrainRender.setPassNum(1);
