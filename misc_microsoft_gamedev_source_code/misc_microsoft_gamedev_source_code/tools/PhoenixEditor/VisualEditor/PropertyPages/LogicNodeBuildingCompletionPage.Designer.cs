...
{
   partial class LogicNodeBuildingCompletionPage
   {
      /// <summary> 
      ...
      private void InitializeComponent()
      {
         ...
         this.groupBox1.Text = "Logic (BuildingCompletion) Properties";
         // 
         // comboBox1
         // 
         this.comboBox1.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
         this.comboBox1.FormattingEnabled = true;
         this.comboBox1.Location = new System.Drawing.Point(102, 75);
         ...
         this.floatSliderEdit.TabIndex = 6;
         ...
         // 
         // LogicNodeBuildingCompletionPage
         // 
         this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
         this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
         this.Controls.Add(this.groupBox1);
         this.Name = "LogicNodeBuildingCompletionPage";
