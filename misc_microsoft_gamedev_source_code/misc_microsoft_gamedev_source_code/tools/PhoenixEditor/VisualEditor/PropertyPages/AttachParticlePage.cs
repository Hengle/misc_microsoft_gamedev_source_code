...
{
   public partial class AttachParticlePage : UserControl
   {
      ...
      public void bindData(visualModelComponentOrAnimAttach attach, TreeNode treeNode)
      {
         ...
         particleFileBrowseControl.FileName = mData.name;
      ...
      public void updateData()
      {
         ...
         afterChanges.type = visualModelComponentOrAnimAttach.AttachType.ParticleFile;
         afterChanges.name = particleFileBrowseControl.FileName;
      ...
      // Even Handlers
      // ---------------------------------
      private void particleFileBrowseControl_ValueChanged(object sender, EventArgs e)
      {
