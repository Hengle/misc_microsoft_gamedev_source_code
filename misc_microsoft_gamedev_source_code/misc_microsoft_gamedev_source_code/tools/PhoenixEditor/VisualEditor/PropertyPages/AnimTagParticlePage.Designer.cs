...
{
   partial class AnimTagParticlePage
   {
      /// <summary> 
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AnimTagParticlePage));
         ...
         this.groupBox1.Text = "Particle Tag Properties";
         // 
         ...
         this.label1.Text = "Particle Effect";
         // 
         // floatSliderEdit1
         // 
