...
{
   public partial class AnimTagGroundIKPage : UserControl
   {
      ...
      public void bindData(visualModelAnimAssetTag model, TreeNode treeNode)
      {
         ...
         lockToGround.Checked = mData.lockToGround;
      ...
      public void updateData()
      {
         ...
         afterChanges.lockToGround = lockToGround.Checked;
      ...
      private void lockToGround_CheckedChanged(object sender, EventArgs e)
      {
         // early out if currently binding data
         if (mIsBindingData)
            return;
