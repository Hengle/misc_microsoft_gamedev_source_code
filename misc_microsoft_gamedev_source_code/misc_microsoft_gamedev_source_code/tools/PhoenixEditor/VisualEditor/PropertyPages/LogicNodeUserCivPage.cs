...
{
   public partial class LogicNodeUserCivPage : UserControl
   {
      ...
      public LogicNodeUserCivPage()
      {
         InitializeComponent();

         // Read tech types
         string civsFileName = "civs.xml";
         string civsFileNameFull = CoreGlobals.getWorkPaths().mGameDataDirectory + "\\" + civsFileName;

         XmlDocument doc = new XmlDocument();
         doc.Load(civsFileNameFull);

         XmlNodeList nodes = null;
         nodes = doc.SelectNodes("//Civ/Name");
