...
{
   public partial class AttachLightPage : UserControl
   {
      ...
      public void bindData(visualModelComponentOrAnimAttach attach, TreeNode treeNode)
      {
         ...
         lightFileBrowseControl.FileName = mData.name;
      ...
      public void updateData()
      {
         ...
         afterChanges.type = visualModelComponentOrAnimAttach.AttachType.LightFile;
         afterChanges.name = lightFileBrowseControl.FileName;
      ...
      // Even Handlers
      // ---------------------------------
      private void lightFileBrowseControl_ValueChanged(object sender, EventArgs e)
      {
