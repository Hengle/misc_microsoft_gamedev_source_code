...
{
   public partial class AttachModelPage : UserControl
   {
      ...
      // Even Handlers
      // ---------------------------------
      private void modelFileBrowseControl_ValueChanged(object sender, EventArgs e)
      {
         ...
         // Rebind so that combo boxes get updated
         bindData(mData, mNode);
      }
