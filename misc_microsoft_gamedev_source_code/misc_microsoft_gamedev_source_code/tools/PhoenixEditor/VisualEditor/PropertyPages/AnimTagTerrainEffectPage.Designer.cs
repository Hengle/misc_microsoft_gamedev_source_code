...
{
   partial class AnimTagTerrainEffectPage
   {
      /// <summary> 
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AnimTagTerrainEffectPage));
         ...
         this.groupBox1.Text = "TerrainEffect Tag Properties";
         // 
         ...
         this.lifespanFloatSliderEdit.TabIndex = 31;
         ...
         this.fileBrowseControl1.FilterExtension = ".tfx";
         this.fileBrowseControl1.FilterName = "TerrainEffect Files";
         ...
         this.fileBrowseControl1.StartFolder = "art\\effects\\terraineffects";
         ...
         this.label1.Text = "Terrain Effect";
         // 
         // floatSliderEdit1
         // 
         ...
         // 
         // AnimTagTerrainEffectPage
         // 
         this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
         this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
         this.Controls.Add(this.groupBox1);
         this.Name = "AnimTagTerrainEffectPage";
