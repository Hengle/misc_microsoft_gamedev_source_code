...
{
   public partial class AnimTagKillAndThrowPage : UserControl
   {
      ...
      public AnimTagKillAndThrowPage()
      {
         InitializeComponent();
      }
      ...
      public void bindData(visualModelAnimAssetTag model, TreeNode treeNode)
      {
         ...
         sampleLengthTextBox.Text = mData.lifespan.ToString();
      ...
      public void updateData()
      {
         ...
         afterChanges.lifespan = System.Convert.ToDecimal(sampleLengthTextBox.Text);
      ...
      private void positionSliderEdit_ValueChanged(object sender, VisualEditor.Controls.FloatSliderEdit.ValueChangedEventArgs e)
      {
       ...
       private void sampleLengthTextBox_LeaveFocus(object sender, EventArgs e)
       {
           // early out if currently binding data
          if (mIsBindingData)
             return;
