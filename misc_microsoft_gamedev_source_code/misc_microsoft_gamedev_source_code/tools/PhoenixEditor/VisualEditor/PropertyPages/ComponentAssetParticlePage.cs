...
{
   public partial class ComponentAssetParticlePage : UserControl
   {
      ...
      public ComponentAssetParticlePage()
      {
         InitializeComponent();
      }
      ...
      public void updateData()
      {
         ...
         afterChanges.type = visualModelComponentAsset.ComponentAssetType.Particle;
