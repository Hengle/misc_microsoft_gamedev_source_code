...
{
   public partial class AnimTagPhysicsImpulsePage : UserControl
   {
      ...
      public AnimTagPhysicsImpulsePage()
      {
         InitializeComponent();
      }
      ...
      public void updateData()
      {
         ...
         afterChanges.start = typeComboBox.SelectedIndex;
         afterChanges.force = System.Convert.ToDecimal(xTextBox.Text);
         afterChanges.force2 = System.Convert.ToDecimal(yTextBox.Text);
         afterChanges.lifespan = System.Convert.ToDecimal(zTextBox.Text);
         afterChanges.checkSelected = attachedCheckBox.Checked;
