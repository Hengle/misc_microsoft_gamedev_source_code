...
namespace EditorCore
{
   ...
   public class PerforceManager
   {
      ...
      {
         string results = CoreGlobals.getPerforce().getConnection().P4Cmd("opened -c " + changelistID.ToString(), "", "");
         if (CoreGlobals.getPerforce().getConnection().mLastError.Contains("not opened"))
         {
            return false;
         }
         return true;
      ...
      public void CleanEmptyChangeLists(string prefix)
      {
         ...
         while (it.MoveNext())
         {
            ...
            {
               if (CoreGlobals.getPerforce().HasFilesOpen(it.Current.Key) == false)
               {
                  //CoreGlobals.ShowMessage("Deleting empty changelist:" + it.Current.Value);
                  CoreGlobals.getPerforce().getConnection().P4DeleteList(it.Current.Key);
               }
      ...
      public Dictionary<int, string> GetCurrentUserChangelists()
      {
         ...
         if(CoreGlobals.getPerforce().getConnection().mSettings.TryGetValue("User name", out userName))
         {
            string results = CoreGlobals.getPerforce().getConnection().P4Cmd("changes -l -s pending -u " + userName, "", "");
   ...
   public class PerforceChangeList
   {
      ...
      public class P4Resource
      {
         ...
         public P4Resource(PerforceChangeList list, string localName, string perforceName, string perforceAction)
         {
            ...
            mStatus = CoreGlobals.getPerforce().getConnection().P4GetFileStatus(mPerforceName);

         }
         public bool Revert()
         {
            return CoreGlobals.getPerforce().getConnection().P4Revert(mList.ID, mPerforceName);
         }
      }
      
      public string GetLastError()
      {
         return CoreGlobals.getPerforce().getConnection().mLastError;
      }
      ...
      public string Description
      {
         ...
         {
            mDescription = value;
            CoreGlobals.getPerforce().getConnection().P4ChangeDescription(ID, mDescription);
         }
         get
         {
            return mDescription;
      ...
      public bool AddFile(string fileName)
      {
         ...
         bool result = CoreGlobals.getPerforce().getConnection().P4Add(ID, fileName);
         mbKnownDirty = true;
         return result;
      }
      ...
      {
         bool result = CoreGlobals.getPerforce().getConnection().P4Sync( fileName);
         bool result2 = CoreGlobals.getPerforce().getConnection().P4Checkout(ID, fileName);
         mbKnownDirty = true;
         return result;
      ...
      {
         bool result = CoreGlobals.getPerforce().getConnection().P4Reopen(ID, fileName);
         mbKnownDirty = true;
         return result;
      }
      public bool SyncFile(string fileName)
      {
         return CoreGlobals.getPerforce().getConnection().P4Sync(fileName); 
      }
      ...
      {
         SimpleFileStatus status = CoreGlobals.getPerforce().GetFileStatusSimple(fileName);
      ...
      {
         bool result =  CoreGlobals.getPerforce().getConnection().P4Revert(ID, fileName);
         mbKnownDirty = true;
         return result;
      ...
      public bool RemoveListAndRevert()
      {
         ...
         bool result = true;
         result &= Revert();
         result &= CoreGlobals.getPerforce().getConnection().P4DeleteList(ID);
      ...
      public bool Submitchanges()
      {
         ...
         bool result = CoreGlobals.getPerforce().getConnection().P4Submit(ID);
         mbKnownDirty = true;
         return result;
      }
      ...
      {
         string changelist = CoreGlobals.getPerforce().getConnection().P4Cmd("change -o ", ID.ToString(), "");
   ...
   public class PerforceConnection 
   {
      ...
      public int CreateChangeList(string description)
      {
         ...
         string output = P4Cmd("change -i", "", input);
   ...
   public class SimpleFileStatus
   {
      ...
      public void Refresh()
      {
         ...
         {
            mStatus = CoreGlobals.getPerforce().getConnection().P4GetFileStatus(mStatus["depotFile"]);

              
         }
         else
         {
            mStatus = CoreGlobals.getPerforce().getConnection().P4GetFileStatus(mFileName);
      ...
      public const int cInvalidVersion = -1;

      public bool TryGetHaveRevision(out int havRev)
      {
         havRev = cInvalidVersion;
         string val;
         if(mStatus.TryGetValue("haveRev", out val))
         {
            if(int.TryParse(val, out havRev))
            {
      ...
      public bool TryGetHeadRevision(out int headRev)
      {
         headRev = cInvalidVersion;
         string val;
         if (mStatus.TryGetValue("headRev", out val))
         {
            if (int.TryParse(val, out headRev))
            {
               return true;
            }
         }
      ...
      {
         return CoreGlobals.getPerforce().getConnection().P4Sync(mStatus["depotFile"]);
...
//stderr: 
//edit -c 8145 F:\phoenix\xbox\work\data\objects.xml
//stdout: //depot/phoenix/xbox/work/data/objects.xml#40 - opened for edit
//... //depot/phoenix/xbox/work/data/objects.xml - must sync/resolve #41,#45 before submitting
//... //depot/phoenix/xbox/work/data/objects.xml - also opened by alaudon@sys442
...
//C:\Documents and Settings\afoster.ENS>p4 fstat f:/phoenix/xbox/work/data/techs.x
//ml
//... depotFile //depot/phoenix/xbox/work/data/techs.xml
//... clientFile f:\phoenix\xbox\work\data\techs.xml
//... headAction edit
//... headType text
//... headTime 1147321902
//... headRev 6
...
//C:\Documents and Settings\afoster.ENS>p4 opened  f:/phoenix/xbox/work/data/objects.xml
////depot/phoenix/xbox/work/data/objects.xml#43 - edit default change (text)

//C:\Documents and Settings\afoster.ENS>p4 opened  f:/phoenix/xbox/work/data/objects.xml
//f:/phoenix/xbox/work/data/objects.xml - file(s) not opened on this client.




//Checked out by two...
//... depotFile //depot/phoenix/xbox/work/data/objects.xml
//... clientFile f:\phoenix\xbox\work\data\objects.xml
//... headAction edit
//... headType text
//... headTime 1147399244
//... headRev 43
...
//C:\Documents and Settings\afoster.ENS>p4 opened -a f:/phoenix/xbox/work/data/*.*

//f:/phoenix/xbox/work/data/civs.xml - file(s) not opened anywhere.
//f:/phoenix/xbox/work/data/Copy of objects.xml - file(s) not opened anywhere.
//f:/phoenix/xbox/work/data/defaultTileTypes.xml - file(s) not opened anywhere.
//f:/phoenix/xbox/work/data/gamedata.xml - file(s) not opened anywhere.
//f:/phoenix/xbox/work/data/gamepads.xml - file(s) not opened anywhere.
//f:/phoenix/xbox/work/data/gamesettings.xml - file(s) not opened anywhere.
//f:/phoenix/xbox/work/data/inputcontrolmap.xml - file(s) not opened anywhere.
//f:/phoenix/xbox/work/data/inputcontrolset.xml - file(s) not opened anywhere.
////depot/phoenix/xbox/work/data/objects.xml#43 - edit default change (text) by af
//oster@sys359
////depot/phoenix/xbox/work/data/objects.xml#39 - edit default change (text) by mh
//anson@SYS363
//f:/phoenix/xbox/work/data/objecttypes.xml - file(s) not opened anywhere.
////depot/phoenix/xbox/work/data/powers.xml#8 - edit default change (text) by mhan
//son@SYS363
//f:/phoenix/xbox/work/data/techs.xml - file(s) not opened anywhere.

//


//C:\Documents and Settings\afoster.ENS>p4 fstat //depot/phoenix/xbox/code/tools/PhoenixEditor/Bin/simrepUpdate.bmp
//... depotFile //depot/phoenix/xbox/code/tools/PhoenixEditor/Bin/simrepUpdate.bmp
//... clientFile f:\phoenix\xbox\code\tools\PhoenixEditor\Bin\simrepUpdate.bmp
//... headAction branch
//... headType binary
//... headTime 1145507778
//... headRev 1
...
//(?<start>.*Description:)(?<description>.*)(?<end>Files:.*)
//${start}
//asdfsdf
//${end}
...
//Edit
//p4 change -o 7841
//p4 fstat -P -C -Ol -e 7841 -W //sys359/...
...
//Files:
//   //depot/phoenix/xbox/code/tools/PhoenixEditor/EditorCore/EditorCore.csproj	# edit
//   //depot/phoenix/xbox/code/tools/PhoenixEditor/EditorCore/Perforce.cs	# edit
//   //depot/phoenix/xbox/code/tools/PhoenixEditor/PhoenixEditor/PhoenixEditor.csproj	# edit
//   //depot/phoenix/xbox/code/tools/PhoenixEditor/PhoenixEditor/TempLightSettings.cs	# edit
//   //depot/phoenix/xbox/code/tools/PhoenixEditor/PhoenixEditor/TempLightSettings.Designer.cs	# edit
//   //depot/phoenix/xbox/code/tools/PhoenixEditor/PhoenixEditor/TempLightSettings.resx	# edit
