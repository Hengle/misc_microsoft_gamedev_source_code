...
namespace NoiseGeneration
{
    ...
    static class Utils
   {
       ...
       static public double SQRT_3 = 1.7320508075688772935;
        ...
        static public double MakeInt32Range (double n)
        {
           return n;
           /*
          if (n >= 1073741824.0) {
     ...
     public static double []g_randomVectors =
     {
   ...
   {
      static public double LinearInterp(double n0, double n1, double a)
      {
         return ((1.0 - a) * n0) + (a * n1);
      }

      static public double CubicInterp(double n0, double n1, double n2, double n3, double a)
      {
      ...
      static public double SCurve3(double a)
      {
      ...
      /// a should range from 0.0 to 1.0.
      /// The first derivitive of a quintic S-curve is zero at @a a = 0.0 and a = 1.0
      /// The second derivitive of a quintic S-curve is zero at @a a = 0.0 and a = 1.0
      static public double SCurve5(double a)
      {
         double a3 = a * a * a;
         double a4 = a3 * a;
         double a5 = a4 * a;
   ...
   public class ClampedFloat
   {
      ...
      public ClampedFloat(float min, float max, float val)
      {
         mMin = min;
         mMax = max;
         mValue = val;
   ...
   {
      private double mMin = 0f;
      private double mMax = 1f;
      private double mValue = 0.5f;

      public ClampedDouble(double min, double max, double val)
      {
         mMin = min;
         mMax = max;
         mValue = val;
