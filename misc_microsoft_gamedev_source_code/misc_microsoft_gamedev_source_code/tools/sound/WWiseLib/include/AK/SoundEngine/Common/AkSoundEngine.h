...
namespace AK
{
	...
	namespace SoundEngine
	{
		...
		/// Post a monitoring message. This allows the Sound Engine user to send a message 
        ...
        extern AKSOUNDENGINE_API AKRESULT PostMsgMonitor(
			AkLpCtstr in_pszMessage						///< Message to be displayed
            );
