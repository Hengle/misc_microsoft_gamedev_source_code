...
#if 0
{
   ...
   BImageUtils::writeTGA24("unpackedLuma.tga", unpackedImage, false);    
   BImageUtils::writeTGA24("unpackedChroma.tga", unpackedChromaImage, false);    
   ...
   BImageUtils::writeTGA24("final.tga", finalImage, false);    
   BImageUtils::writeTGA24("finalA.tga", finalImage, true);    
